...
export const Header = ({ userRole }) => {
  ...
  if (userRole === "student" || userRole === "teacher" || userRole === "applicant" || userRole === "admin") {
    return (
      <div className='header'>
          ...
          onClick={()=> setShowAccountOption(true)}>
            <AccountOption show={showAccountOption} onClose={() => setShowAccountOption(false)}/>
